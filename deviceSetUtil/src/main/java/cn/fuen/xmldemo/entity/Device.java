package cn.fuen.xmldemo.entity;
...
import cn.fuen.xmldemo.model.M10A_GPIOUtil;
import cn.fuen.xmldemo.model.M10_GPIOUtil;
import cn.fuen.xmldemo.model.M96_GPIOUtil;
...
public class Device {
	...
	private void dealGPIO(String gpioPort, String gpio) {
		...
		if (gpioPort.equals("gpio898")) {
			if (gpio.equals("1")) {
				M10A_GPIOUtil.gpio898_1();
			} else if (gpio.equals("0")) {
				M10A_GPIOUtil.gpio898_0();
			}
			...
			if (gpio.equals("1")) {
				M10A_GPIOUtil.gpio909_1();
			} else if (gpio.equals("0")) {
				M10A_GPIOUtil.gpio909_0();
			}
		} else if (gpioPort.equals("gpio910")) {
			if (gpio.equals("1")) {
				M10A_GPIOUtil.gpio910_1();
			} else if (gpio.equals("0")) {
				M10A_GPIOUtil.gpio910_0();
			}
		}
		/************** M96 **************************************/
